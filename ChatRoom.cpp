...
void ChatRoom::display_cmd() {
    ...
    cout << "\033[1;36m1.查看已发消息 2.查看收到的消息 3.发送消息 4.撤回消息 5.展示聊天记录 6.返回用户主界面\033[0m" << endl;
    cout << "\033[1;36m===============================================================================\033[0m" << endl;
    cout << endl << "输入操作: ";
}
...
void ChatRoom::display_log() {
    ...
    cout << "查询到聊天记录如下: " << "\033[1;32m→\033[0m"  << "表示接收, " << "\033[1;34m←\033[0m"  << "表示发送" << endl;
    cout << "=========================================================================" << endl;
    cout << "       \033[1;32mHe/She\033[0m";
    cout << "                                   " << "\033[1;34mMe\033[0m" << endl;
    for (const auto &cht: res) {
        if(cht.sender == user_id){ //我发的消息
            cout << "                                       ";
            cout << "\033[1;34m←[\033[0m" << cht.c_time << "\033[1;34m]\033[0m" << endl;
            cout << "                                       ";
            cout << "\033[1;34m←\033[0m" << cht.context << endl << endl;
        }
        if(cht.receiver == user_id){ //我收到的消息
            cout << "\033[1;32m→[\033[0m" << cht.c_time << "\033[1;32m]\033[0m" << endl;
            cout << "\033[1;32m→\033[0m" << cht.context << endl << endl;
        }
    }
    cout << "=========================================================================" << endl;
}
